...
- Run `npm run check` for application/data changes and `npm run test:e2e` for layout or gesture changes (after building). CI additionally verifies fixture regeneration. Pages deploys from `main` after checks pass.
